...
{
    public partial class CreateDb_CustAcc_CustAccActiv_IdentityDefault : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "CustomerAccountsActivities",
                columns: table => new
                {
                    CustomerAccountActivityID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CustomerAccountsActivities", x => x.CustomerAccountActivityID);
                });
